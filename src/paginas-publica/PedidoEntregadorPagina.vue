        ...
        <section class="order-results">
            ...
            <div class="results-list">
                ...
                <div v-for="item in pedidos" :key="item.id" class="order-item" data-status="pending">
                    ...
                    <button @click="SolicitarEntregador(item.id)" class="aceitar-btn">Aceitar</button>
                    <button @click="SolicitarEntregador(item.id)" class="rejeitar-btn">Rejeitar</button>
                </div>
...
.detalhar-btn {
    background-color: #cccccc; /* Cinza mais carregado */
    color: black;
    border: none;
    padding: 8px 16px;
    border-radius: 4px;
